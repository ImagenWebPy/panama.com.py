    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <?= utf8_encode($this->empresa[0]['contenido']); ?>
            </div>
        </div>
    </div>
</section>
<?php if ($this->empresa[0]['mostrar_contratar'] == 1): ?>
    <section>
        <div class="container">
            <div class="row">
                <div class="col-lg-12 cool-md-12">
                    <h3><?= utf8_encode($this->empresa[0]['titulo_contratar']); ?></h3>
                    <?= utf8_encode($this->empresa[0]['contenido_contratar']); ?>
                    <p><a href="#" class="m-btn" data-size="normal" data-color="primary"><?= utf8_encode($this->empresa[0]['boton_contratar']); ?></a></p>
                </div>
            </div>
        </div>
    </section>
